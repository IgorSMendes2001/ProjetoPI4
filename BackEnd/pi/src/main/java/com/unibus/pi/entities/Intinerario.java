...
public class Intinerario implements Serializable {
    ...
    public Intinerario(Integer id, String pontoInicial,String percurso, String pontoFinal, Rota rota,Horario horario) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Intinerario)) return false;
        Intinerario that = (Intinerario) o;
